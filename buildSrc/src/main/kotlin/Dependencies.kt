object Dependencies {
    ...
    const val ADAPTER_RXJAVA2 = "com.squareup.retrofit2:adapter-rxjava2:${BuildDependenciesVersions.RETROFIT}"
    ...
    const val COORDINATOR_LAYOUT = "androidx.coordinatorlayout:coordinatorlayout:${BuildDependenciesVersions.COORDINATOR_LAYOUT}"
    const val VIEW_PAGE2 = "androidx.viewpager2:viewpager2:${BuildDependenciesVersions.VIEW_PAGE2}"
}